...
# Twitter API
TWITTER_BEARER_TOKEN = "AAAAAAAAAAAAAAAAAAAAAMIL4wEAAAAAAbat2206L4xNE1CR6BzWUViDhAM%3Dvw9fE4WbV4dfbOvjesscRI6R8evnr881eqnnM9ibexPbGJDH04"
...
if __name__ == '__main__':
    print("=" * 60)
    print("[START] Social Media Sentiment Tracker - Flask Backend")
    print("=" * 60)
